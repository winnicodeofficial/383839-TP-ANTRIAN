@extends('layouts2.main', ['title' => 'Halaman Data Rekap', 'page_heading' => 'Data Rekap'])
...
<section class="section custom-section">
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            ...
                            -->
                            <button type="button" class="btn btn-success ml-3" data-toggle="modal" data-target="#exportModal1">
                                <i class="fas fa-fw fa-file-excel"></i>&nbsp; Export
                            </button>
                            <!--
    ...
    <div class="modal fade" id="tambahDataModal" tabindex="-1" role="dialog" aria-labelledby="tambahDataModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('cek-rekap') }}" method="post">
                        @csrf
                        <label for="nomor_antrian">Cek Data Rekap</label>
                        <input type="text" class="form-control" id="nomor_antrian" name="nik" placeholder="Masukkan NIK" required>
    ...
    <!-- Modal Export -->
    <div class="modal fade" id="exportModal1" tabindex="-1" role="dialog" aria-labelledby="exportModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!-- Form untuk memasukkan tanggal mulai dan tanggal selesai -->
                    <form action="{{ route('excel.rekap.export') }}" method="get">
                        @csrf
                        <div class="form-group">
